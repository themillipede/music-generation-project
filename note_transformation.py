...
def normalise_midi_melody_key(melody_input, scale_steps, key_code, normalised_melody_output):
    ...
    for note in melody:
        ...
        normalised_note = pm.Note(velocity=note.velocity, pitch=normalised_pitch, start=note.start, end=note.end)
