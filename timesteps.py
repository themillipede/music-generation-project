class Piece:
    def __init__(self, title, composer, pickup_duration, melody, chords, bars):
        ...
        self.timesteps = []
        this_note = TempObject()
        this_chord = TempObject()
        this_bar = TempObject()
        n = -1
        c = -1
        b = -1
        ...
        while n < len(melody) or c < len(chords) or b < len(bars):
            ...
            if timestep_duration > 0:
                this_timestep = Timestep(
                    ...
                    chord_type=this_chord.type_chordset,
                    chord_full=this_chord.full_chordset,
...
class Timestep:
    ...
    """
    def __init__(self, note_name, note_octave, note_pitch, root, bass, chord_type,
                 chord_full, bar_number, duration, is_tied, is_barline, same_note):
